@extends('admin.order.complete.main')
        ...
        @foreach($order as $index => $od)
            ...
            <div class="tableSmall appear-on-small">
                ...
                <p class="appear-on-small text-center d-flex justify-content-center align-items-center gap-2">
                    <a href="" type="button" class="btn btn-warning d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#staticBackdropView{{ $od->id }}"><i class="ri-file-list-fill"></i>Detail</a>
                </p>
            </div>
        @endforeach
    </tbody>
