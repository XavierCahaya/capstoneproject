...
<div class="container p-4">
    ...
    <div class="col-lg-3 col-md-6 mb-1 text-center">
        <h5 class="mb-1" style="letter-spacing: 2px; color: #FC3E24;">Jam Operasional</h5>
        ...
        <div class="d-flex justify-content-center align-items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill align-self-center" viewBox="0 0 16 16">
...
<div class="text-center text-light p-3" style="background-color: rgba(252, 62, 36, 1);">
    © 2023 Copyright :
    <a class="text-light" href="https://mdbootstrap.com/" >DevTeam-CP2</a>
</div>
<!-- Copyright -->
</footer>
