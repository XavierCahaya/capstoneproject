...
<div class="d-flex justify-content-center my-4">
    <span class="fs-5 py-3 rounded text-center px-4" style="background: #FC3E24; color:white;">
                ...
                <div class="card-product card" style="width: 15rem; border-radius:20px;">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-around mb-2">
                            ...
                            <h6 class="card-title p-1" style="background-color:#D4DF52; border-radius:10px; font-size:12px;">
                                {{ $product->category->name }}
                            </h6>
                        </div>
                        <p class="card-text text-center" style="font-size: 15px">{{ $product->name }}</p>
                        <div class="d-flex justify-content-around">
                            <a href="#" class="btn btn-detail" style="background-color:#1FD8CD; border-radius:10px; font-size:12px; padding:8px;">Lihat
                                Detail</a>
                            <a href="#" class="btn btn-pesan btn-add-to-cart" data-product-id="{{ $product->id }}" data-product-price="{{ $product->price }}" style="background-color:#0AD82B; border-radius:10px; font-size:12px; padding:8px;">Pesan</a>
